...
defList(RETAINEDPUBLICATIONS)

def SUBSCRIPTIONENGINES
{
	n32 ptr SUBSCRIPTIONSList open "subs"
	n32 ptr RETAINEDPUBLICATIONSList open "retaineds"
	n32 dec "retained_changes"
	struct
	{
		n32 ptr SUBSCRIPTIONSList open "system_subs"
		n32 ptr RETAINEDPUBLICATIONSList open "system_retaineds"
	}
}
BE*/
/**
...
typedef struct
{
	List* subs;			/**< main subscription list */
	List* retaineds;	/**< main retained message list */
	int retained_changes;	/**< flag to show whether changes have been made since last save */
	struct
	{
		List* subs;			/**< system topics */
		List* retaineds;	/**< system retained messages */
